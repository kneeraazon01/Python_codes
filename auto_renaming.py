import os
os.chdir(
    '/home/kneeraazon/Downloads/True Detetive/True Detective Season 1 COMPLETE 720p HDTV x264 [MKV,AC3,5.1] Ehhhh')


# print(os.getcwd())  # is the right directory?
