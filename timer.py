...
class Timer(tk.Tk):
    def __init__(self):
        ...
        self.button_add = tk.Label(
            self.button_frame, text="+", font=(FONT_NAME, ADD_SIZE)
        )
        self.button_add.grid(column=0, row=0, sticky="WE")
        self.button_add.bind("<Button-1>", self.create_counter)

        self.button_start = tk.Label(
            self.button_frame, text="Start", font=(FONT_NAME, ADD_SIZE)
        )
        self.button_start.grid(column=1, row=0, sticky="WE")
        self.button_start.bind("<Button-1>", self.start_all)

        self.button_stop = tk.Label(
            self.button_frame, text="Pause", font=(FONT_NAME, ADD_SIZE)
        )
    ...
    def create_counter(self, event=None):
        ...
        delete_button = tk.Label(
            frame, text="X", fg="red", font=(FONT_NAME, DELETE_SIZE)
        )
        ...
        self.counters.append(dict(counter=counter, frame=frame))
...
class Counter(object):
    def __init__(self, master):
        ...
        self.title = tk.Entry(
            self.frame, font=(FONT_NAME, LABEL_SIZE), textvariable=self.title_text
        )
